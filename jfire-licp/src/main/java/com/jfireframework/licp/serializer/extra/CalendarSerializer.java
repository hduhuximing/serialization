...
public class CalendarSerializer implements LicpSerializer<Calendar>
{
    ...
    @Override
    public void serialize(Calendar src, ByteBuf<?> buf, Licp licp)
    {
    ...
    @Override
    public Calendar deserialize(ByteBuf<?> buf, Licp licp)
    {
    ...
    @Override
    public Calendar deserialize(ByteBuffer buf, Licp licp)
    {
